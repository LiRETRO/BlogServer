...
public class Blog implements Serializable {
     ...
     * 主键ID
     */
    @ApiModelProperty(value = "博客主键Id, 16位数字", dataType = "String", required = true, accessMode = ApiModelProperty.AccessMode.READ_ONLY)
     ...
     * 封面附件Id
     */
    @ApiModelProperty(value = "博客封面附件Id", dataType = "String")
    private String blogCoverAttachNo;
    /**
     * 内容图片附件Id
     */
